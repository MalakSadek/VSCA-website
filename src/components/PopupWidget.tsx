  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <DisclosureButton className="fixed z-40 flex items-center justify-center transition duration-300 bg-primary rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-primary-600 focus:bg-primary-600 ease">
                  ...
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ...
                              : "border-gray-300 focus:border-primary ring-primary-100"
                          }`}
                        />
                        {errors.name && (
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-primary rounded-md focus:bg-primary-600 focus:outline-none"
                        >
                          {isSubmitting ? (
                            <svg
